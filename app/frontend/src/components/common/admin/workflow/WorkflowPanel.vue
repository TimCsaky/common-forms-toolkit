<template>
  <v-card outlined class="mx-auto workflow-panel">
    ...
    <h2 class="workflow-heading">Status</h2>
    <div v-if="!loading">
      <p>
        ...
        <v-row>
          <v-col cols="12" xl="8" offset-xl="2">
            ...
            <v-select
              ...
              item-value="code"
              v-model="statusToSet"
              data-test="select-workflow-statusToSet"
            ...
            <div v-show="statusFields">
              <div v-if="showActionDate">
                ...
                <v-menu
                  ...
                  data-test="menu-workflow-actionDateMenu"
                ...
                >
                  <template v-slot:activator="{ on }">
                    <v-text-field
                      v-model="actionDate"
                      data-test="text-workflow-actionDate"
                  ...
                  <v-date-picker
                    v-model="actionDate"
                    data-test="picker-workflow-actionDate"
              ...
              <div v-if="showInspector">
                ...
                <v-text-field
                  v-model="assignedTo"
                  data-test="text-workflow-assignedTo"
                ...
                <v-text-field
                  ...
                  data-test="text-workflow-assignedToEmail"
                  dense
                  flat
                  outlined
                  solo
                ...
                <div class="text-right">
                  <v-btn
                    ...
                    data-test="btn-workflow-assign-self"
                  >
        ...
        <v-row>
            ...
            <v-dialog v-model="historyDialog" width="1200">
              <template v-slot:activator="{ on }">
                <v-btn
                  ...
                  outlined
                  color="textLink"
                  data-test="btn-workflow-view-history"
                  v-on="on"
                >
              ...
              <v-card v-if="historyDialog">
                ...
                <v-card-actions>
                  ...
                  <v-btn
                    ...
                    color="primary"
                    data-test="btn-workflow-close-status-table"
                    text
                  >
                    <span>CLOSE</span>
                  </v-btn>
          ...
          <v-col cols="12" sm="6" xl="4" order="first" order-sm="last">
            <v-btn
              block
              color="primary"
              data-test="btn-workflow-update-status"
              :disabled="!hasReviewer"
              v-on="on"
              @click="updateStatus"
            >
...
import StatusTable from '@/components/common/admin/workflow/StatusTable.vue';
    ...
    async getworkflowData() {
      ...
      try {
        ...
        if (!this.statusHistory.length || !this.statusHistory[0]) {
          this.error = 'No workflow statuses found';
        } else {
