...
import AdminReviewSubmission from '@/components/formone/admin/AdminReviewSubmission.vue';
import WorkflowPanel from '@/components/common/admin/workflow/WorkflowPanel.vue';
import NotesPanel from '@/components/common/admin/workflow/NotesPanel.vue';
...
export default {
  ...
  computed: {
    ...
    resource() {
      return AppClients.FORMONE;
    }
  },
  methods: {
    ...mapMutations('formOne', ['setGettingForm']),
    ...mapActions('formOne', ['getForm']),
    refreshNotes() {
